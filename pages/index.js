...
// Load market data at build time so the compact overview is server-rendered
...
try {
  // require the public JSON file (available at build time)
  ...
  // keep default tableHtml if loading fails; log during build
  // console.warn('Could not load market data at build time', err);
}
